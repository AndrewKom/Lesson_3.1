...
import com.mirea.komkovaa.ls3_kr.databinding.FragmentCameraBinding;

import java.io.File;
import java.io.IOException;


public class camera extends Fragment implements ActivityResultCallback<ActivityResult> {
