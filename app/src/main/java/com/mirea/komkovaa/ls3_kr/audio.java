...
import com.mirea.komkovaa.ls3_kr.databinding.FragmentAudioBinding;
...
public class audio extends Fragment {
    ...
    private com.mirea.komkovaa.ls3_kr.databinding.FragmentAudioBinding binding = null;
    ...
    private void OnRecordButtonClicked() {
        Intent serviceIntent = new Intent(getActivity(), servicePl.class);
        ...
        switch (state) {
            ...
            case RECORD: {
                getActivity().stopService(
                        new Intent(getActivity(), servicePl.class));
                StopRecord();
                break;
            }
            case PLAYING: { break; }
